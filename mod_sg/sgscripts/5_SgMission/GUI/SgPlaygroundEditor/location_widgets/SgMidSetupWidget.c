class SgMidSetupWidget extends SgLocationSetupWidget
{
	void SgMidSetupWidget( Widget root, SgJsonLocation location, SgPlaygroundEditorMenu editor, SgJsonLocationAIGroupsSpawnData locationAIGroupsSpawnData )
	{
		m_Root						= GetGame().GetWorkspace().CreateWidgets( "mod_sg/gui/layouts/sg_playground_editor/setup_widgets/pg_mid_settings_panel.layout", root );
		m_Location					= location;
		...
		m_LocationType.SetText( "Location Type: Second Phase" );
