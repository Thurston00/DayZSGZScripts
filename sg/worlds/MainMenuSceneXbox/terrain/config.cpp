...
//'now' is Tue Jul 23 06:59:59 2019 : 'file' last modified on Thu Apr 11 10:50:54 2019
////////////////////////////////////////////////////////////////////
...
class CfgPatches
{
	class DZ_Worlds_MainMenuSceneXbox_World
	{
		units[] = {};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class MainMenuSceneXbox
	{
		class MainMenuSceneXbox_01
		{
...
class CfgWorlds
{
	...
	class MainMenuSceneXbox: CAWorld
	{
		access = 3;
		worldId = 1;
		cutscenes[] = {"SG_SeverogradIntro1"};
		description = "MainMenuSceneXbox";
		worldName = "\sg\worlds\MainMenuSceneXbox\terrain\MainMenuSceneXbox.wrp";
		class Navmesh
		{
			navmeshName = "\sg\Worlds\MainMenuSceneXbox\navmesh\navmesh.nm";
		...
		{
			satellite = "sg\worlds\MainMenuSceneXbox\data\outside_sat_co.paa";
		...
		noDetailDist = 40;
		fullDetailDist = 15;
		midDetailTexture = "sg\worlds\MainMenuSceneXbox\data\middle_sat_mco.paa";
		terrainNormalTexture = "sg\worlds\MainMenuSceneXbox\data\global_nohq.paa";
...
class CfgMissions
{
	class Cutscenes
	{
		class MainMenuSceneXboxIntro1
		{
			directory = "sg\worlds\MainMenuSceneXbox\data\scenes\intro.MainMenuSceneXbox";
		};
	};
};
